...
struct PrivacySummaryView: View {
    var body: some View {
        List {
            Section {
                Text("TV Remote Control does not collect, transmit, sell or share personal data with WorksBien Studios. It contains no advertising or analytics SDKs.")
            }
